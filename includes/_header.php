    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                <aside class="header__section-center navigation-section">
                    <div class="open-menu">
                    ...
                    <ul class="navigation-section__menu">
                        <li class=""><a href="process.php">The process</a></li>
                        <li><a href="our-offer.php">Our Offer</a></li>
                        <li><a href="our-price.php">Our pricing</a></li>
